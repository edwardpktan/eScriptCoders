...
*/
/*
const generateCategoryListHTML = (categories) => {
    ...
    categories.forEach(category => {
      const categoryListItem = categoryListContainer.querySelector(`li:contains(${category.name})`);
      categoryListItem.addEventListener("click", () => {
        const selectedCategoryContainer = document.getElementById("selected-category");
        selectedCategoryContainer.innerHTML = generateCategoryHTML(category);
      });
    });
  }
  */
